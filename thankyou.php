 ...
 <section class="thankyou-sec">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
            <h1 class="black-text fade-in-bottom">You have joined the exclusive waitlist</h1>
            <p class="small-text fade-in extra-padding">Keep an eye on your inbox for the latest updates</p>
            </div>
        ...
        <div class="row">
            ...
            <a href="/waitlist/">Return to Home</a>
            </div>
        </div>
